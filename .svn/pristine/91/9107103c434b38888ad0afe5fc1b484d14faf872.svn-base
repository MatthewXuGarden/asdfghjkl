 ...
 function callback_alarmAJAXRefresh(xml)
 {
	 ...
	 if(xml.getElementsByTagName("status")[0] != null)
	 {
		...
		if(status == "red")
		{
			...
			{
				tdalarmimg.innerHTML = "<img id='alarmImg' src='images/menusx/multi_icon.png' title=''  border='0' " +(multimessage_on=='true'?"style='cursor:pointer;' onclick=onSelectPage('SiteSafety.jsp');":"")+ " >";
			}
			else
			{
				tdalarmimg.innerHTML = "<img id='alarmImg' src='images/menusx/multi_icon.png' title=''  border='0' " +(alarm_on=='true'?"style='cursor:pointer;' onclick=onSelectPage('Alarms.jsp');":"")+ ">";
			}
		}
		else if(status == "yellow")
		{
			tdalarmimg.innerHTML = "<img id='alarmImg' src='images/menusx/multi_icon_orange.png' title='' border='0' " +(multimessage_on=='true'?"style='cursor:pointer;' onclick=onSelectPage('SiteSafety.jsp');":"")+ " >";
		}
		else if(status == "ok")
		{
