...
FaxListBox.setScreenH(sessionUser.getScreenHeight());
FaxListBox.setScreenW(sessionUser.getScreenWidth());
String faxlistbox = new FaxListBox().getFaxListBox(idsite,actioncode, language);
