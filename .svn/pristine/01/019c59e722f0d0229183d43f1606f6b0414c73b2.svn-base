...
public class HTMLTable extends HTMLElement
{
    ...
    private String NTcreateDivTbTitle(int h, int w)
    {
        ...
        /*
        sb.append("<div id=\"LWTitle"+this.tableId+"\" class=\"LWTitle\" style=\"height:" + h +
            "px; width:100%;");
        sb.append(
    ...
    private String NTcreateDivData(int h, int w)
    {
        ...
        sb = "<div id=\"LWCtDataName" + this.tableId + "\" onscroll=\"LV_HScroll(" +
            ...
            "height:" + (h - 26) +
            "px; width:100%;overflow:auto;\"></div>\n";
    ...
    {
        String sTableHead = "";
        sTableHead = "<table id=\"" + tableName + "\" class=\"table\" border=\"0\" width=\"100%\" onMouseUp=\"" +
    ...
    private String NTcreateHTableRows()
    {
        ...
        for (int i = 0; i < columns; i++)
        {
            ...
            {
            	sb.append("<div id=\"" + this.tableId + "div" + i + "\" style=\""
            			+ "height:18px;cursor:pointer;overflow:hidden;\"");
            }
    ...
    private String paginTable()
    {
        ...
        if (isPage)
        {
            ...
            sb.append("<td align='right' class='pageNum' id=\"page" + this.tableId +
                "\"><input type=text size='4' id='ListViewPaging_"+this.tableId+"' "+vkClass+" onkeydown='checkOnlyNumber(this,event);pageSetInput_keydown(this,"+this.tableId+",event);' onblur='onlyNumberOnBlur(this);' value='"+this.pageNumber+"'></td>");
