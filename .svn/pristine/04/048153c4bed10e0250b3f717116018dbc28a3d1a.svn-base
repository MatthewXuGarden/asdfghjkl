...
public class ExpNote extends ExpMaster 
{
	private static final String SQL = "select * from hsnote where idsite = ? and lastupdate > ?";
	
	public ExpNote(String db,String lang,String tab,long last)
	{
