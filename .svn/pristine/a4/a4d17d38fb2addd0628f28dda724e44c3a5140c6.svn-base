...
comborelay.append("<SELECT class='selectB' id='relay_combo' name='relay_combo' size='"+rows+"' style='width:100%;height:100%;' ondblclick='addRelayMaxItemsChk(" + RuleConstants.MAX_RELAY_ITEMS + ")'>");
RelayBean tmp = null;
int idvar = 0;
//String device_desc = "";
				...
				<TABLE align='center' border="0" width="100%">
					...
					<TD valign="top" width="45%">
						<TABLE width="100%" cellspacing='1' cellpadding='1' align="center" border="0">
							...
							<TR>
								<TD width='80%'><%=comborelay.toString()%></TD>
...
<SCRIPT type="text/javascript">
	...
	if(thisbodyy>sz){
		document.getElementById('relay_combo').style.height = thisbodyy-sz;
		document.getElementById('relaydiv').style.height = thisbodyy-sz;
	}
</SCRIPT>
