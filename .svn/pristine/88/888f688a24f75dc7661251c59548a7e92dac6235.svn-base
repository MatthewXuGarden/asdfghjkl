...
//FAX
SmsListBox smslistboxobj = new SmsListBox();
smslistboxobj.setScreenH(sessionUser.getScreenHeight());
smslistboxobj.setScreenW(sessionUser.getScreenWidth());

String smslistbox = smslistboxobj.getSmsListBox(idsite,actioncode, language);
