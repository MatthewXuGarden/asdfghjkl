...
String haccp = lan.getString("setaction2","haccp");
String historical = lan.getString("setaction2","historical");
...
String emaillistbox = new EmailListBox().getEmailListBox(idsite,actioncode,language,action_type != null ? action_type : "P");
...
<FORM id="frm_set_report" name="frm_set_report" action="servlet/master;jsessionid=<%=jsession%>" method="post">
...
<table border="0" cellpadding="1" cellspacing="1" width="100%" height="55%">
	<tr>
		<td>
			<FIELDSET class='field' style="height:93%">
