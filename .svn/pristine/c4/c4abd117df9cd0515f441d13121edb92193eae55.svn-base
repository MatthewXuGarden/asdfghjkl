...
String emaillistbox = new EmailListBox().getEmailListBox(idsite,actioncode,language);

String modemAvailableString = EmailListBox.GetDeviceConf(idsite,language);
...
<table border="0" cellpadding="1" cellspacing="1" width="100%" height="95%">
	...
	<tr height="5%">
		<td align="center" class="standardTxt"><font color="#FF0000"><%=modemAvailableString%></font></td>
	</tr>
</table>
</FORM>
