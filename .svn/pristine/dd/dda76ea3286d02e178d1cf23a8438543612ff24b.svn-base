...
public class LineCarelInfoList extends LineInfoList
{
    public LineCarelInfoList(String dbId, String plantId) throws DataBaseException
    {
    	String sql = "select * from cfline where typeprotocol = ? order by code";
        RecordSet recordSet = DatabaseMgr.getInstance().executeQuery(dbId, sql, new Object[]{"CAREL"});
        Record record = null;
