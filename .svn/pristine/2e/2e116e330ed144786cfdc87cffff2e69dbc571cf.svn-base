...
<%
	...
	ConfigurationGraphBeanList configurationGraphBeanList= new ConfigurationGraphBeanList(GraphConstant.TYPE_HISTORICAL);
	...
	if(configurationGraphBeans!=null){
		for(int i=0;i<configurationGraphBeans.length;i++){
			if (configurationGraphBeans[i] != null) {
				...
				tableMerged	.append("<td><table cellspacing='0' style='border-radius:14px;border:2px solid black;height:19px;width:100%;'><tbody><tr><td id='txtcolor")
    ...
    // ENHANCEMENT 20090123 - virtual keyboard always enabled
    // Alessandro 20100119 - la virtual keyboard NON deve essere sempre abilitata
...
<%
	// Choice class for quick choice input text
	String classForBlockText = "standardTxt";
	if(OnScreenKey)
		classForBlockText = "keyboardInput";
%>
									...
									<table border="0">
										...
										<tr valign="middle">
											...
											<td style='width:100px;height:50px'>
												...
												<div id="blockLabelContainer" style="display:block;visibility:<%= (displayComboBlocks.equalsIgnoreCase("T")?"visible":"hidden") %>">
														...
														<tr>
															...
															<td class="standardTxt">
																<div id="layer_select_block" class="graphComboSelect">
																	<select id="grouplabel" style='width:110px;font-size:8pt;height:20px;' onchange="mgManageEditSel();applyBlockCheckbox(this);">
																		<option value="0"></option>
																	</select>
																</div>
																<div id="layer_select_block_text" class="graphComboInput">
																	<input type="text" class="<%=classForBlockText %>" name="grouplabelText" id='grouplabelText' maxlength="15" style='width:92px;font-size:8pt;height:20px;'>
																</div>
															</td>
															<td>
																<div class="graphComboOther">
											...
											<td class="groupCategory_small" style='width:110px;' onclick="OpenGraphDialog();">
												<b><%=langService.getString("graphvariable","opengraphdialog")%></b>
											</td>
											
											<td style="width:320px;">										
										        <div>
											        <div style="float:right;" ><img src="images/graph/dxdx2_on.png" style="cursor:pointer;" onclick="nextPeriod();" alt="<%= langService.getString("graphbutton","nextpage")%>" />&nbsp;</div>
											        <div style="float:right;" ><img src="images/graph/dx2_on.png" style="cursor:pointer;" onclick="nextStep();" alt="<%= langService.getString("graphbutton","next")%>" /></div>
											        <div style="float:right;" ><img src="images/graph/sx2_on.png" style="cursor:pointer;" onclick="previeousStep();" alt="<%= langService.getString("graphbutton","previous")%>" /></div>
											        <div style="float:right;" ><img src="images/graph/sxsx2_on.png" style="cursor:pointer;" onclick="previousPeriod();" alt="<%= langService.getString("graphbutton","previouspage")%>" /></div>
									    	        <div style="float:right;">&nbsp;</div>
										    	    <div style="float:right" ><img id="zoomOutImg" src="images/graph/zoomout_on.png"  style="cursor:pointer;" onclick="backZoom();" alt="<%= langService.getString("graphbutton","zoomout")%>" /></div>
									        	</div>
											</td>	
											
											<td class="groupCategory_small" style='width:110px;' onclick="openGraphLayoutConfig('<%=GraphConstant.TYPE_HISTORICAL%>');">
...
<div id="data" style="display:none;">
    	...
    	<div id="typeGraph"><%=GraphConstant.TYPE_HISTORICAL%></div>
	...
	<form style='display:none;' name="frmCosmeticGraph" id="frmCosmeticGraph" action="servlet/master;jsessionid=<%=jsession%>" method="post" >
	    ...
	    <input type="hidden" name="typeGraphCosmetic" id="typeGraphCosmetic" value="<%=GraphConstant.TYPE_HISTORICAL%>"/>
