package com.carel.supervisor.dataaccess.reorder.test.insert.testcasee;
...
public class InsertDB {
	...
	private static final int NEW_KMAX=19;
	...
	public static void main(String[] args) throws Exception {
		...
		for(int i=0;i<KACTUAL+1;i++){
					
			objects[2]= new Short((short)i);
