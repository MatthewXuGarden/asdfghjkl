...
public class ExpArea extends ExpMaster
{
	private static final String SQL = 
		"select cfarea.*,cftableext.description from cfarea inner join cftableext on " +
		"cfarea.idarea = cftableext.tableid and cftableext.tablename='cfarea' and "+
		"cftableext.languagecode = ? and cfarea.idsite = ?";
		
	public ExpArea(String db,String lang,String tab,long last)
	{
