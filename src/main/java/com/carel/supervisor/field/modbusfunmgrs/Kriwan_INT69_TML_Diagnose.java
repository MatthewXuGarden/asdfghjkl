...
public class Kriwan_INT69_TML_Diagnose implements IFunctionMgr
{
	...
	private Kriwan_INT69_TML_Diagnose() {
	...
	public static IFunctionMgr getInstance() {
		if (me == null)
			me = new Kriwan_INT69_TML_Diagnose();
		return me;
	}
	...
	public float applyFunction(long value, Variable v)
	{
		...
		case 1:
			...
			Variable v5 = getVariable(v.getInfo().getDevice(),"ODPTDA");
			...
			float v5_v = v5.getCurrentValue();
			
			float real_v = (v1_v+v2_v+v3_v+v4_v+v5_v)>=1?1:0;
