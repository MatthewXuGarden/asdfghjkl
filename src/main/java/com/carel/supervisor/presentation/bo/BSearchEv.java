...
public class BSearchEv extends BoMaster
{
    private static final int REFRESH_TIME = -1;
        private static final String EXPORT_PDF_CMD = "exportpdf";

    public BSearchEv(String l)
    {
    ...
    protected Map initializeRefresh()
    {
        ...
        RefreshBean[] rb = 
            {
                new RefreshBean("EventTable", IRefresh.R_EVENTSSEARCH, 0, "")
            };
...
//        p.put("tab1name","enableAction(1);enableAction(2);resizeTableEventFound();check_limit();");
        p.put("tab1name","enableAction(1);enableAction(2);resizeTableEventFound();");
    ...
    protected Properties initializeJsOnLoad()
    {
    	...
    	Properties p = new Properties();
        p.put("tab1name", "alev.js;alrevnsearch.js;resizeTable.js;evnview.js;../arch/FileDialog.js" + virtkey);
	...
	public String executeDataAction(UserSession us, String tabName,
		...
		AlarmEventList alevList = new SearchAlarmEvent().find(us, -1, false, true, false);
		...
		try {
			...
			if(fileN == null || fileN.equals("")  || fileN.equals("undefined"))
				fileN = "Events_" + DateUtils.date2String(new Date(), "yyyyMMddhhmmss");


			exporter.startExport(fileN, langcode);

			exporter.setSiteName(us.getSiteName());
			exporter.setTitle(lan.getString("alrevnsearch", "tab2name"));
