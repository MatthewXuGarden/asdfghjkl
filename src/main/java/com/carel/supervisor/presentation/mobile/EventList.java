...
{
    private final static int NUM_EVENTS_4_PAGE = 22;
    ...
    private HTMLTable getHTMLEventTablePrv(String tableName, UserSession us)
    {
        ...
        eventTable.setColumnSize(0, 100);
        eventTable.setColumnSize(1, 70);
        eventTable.setColumnSize(2, 40);
