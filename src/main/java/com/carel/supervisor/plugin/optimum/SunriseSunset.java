...
public class SunriseSunset {
     ...
     */
    public static List<Double> getYearOfSunlightForPoint(int year, double latitude, double longitude, TimeZone tz) {
    ...
    public static long getSunlight(double latitude, double longitude, Date date) {
        return getSunlight(latitude, longitude, date, SunriseSunset.CIVIL_ZENITH, TimeZone.getDefault());
    }
     ...
     * @return
     */
    public static long getSunlight(double latitude, double longitude, Date date, TimeZone tz) {
        return getSunlight(latitude, longitude, date, SunriseSunset.CIVIL_ZENITH, tz);
    }
     ...
     */
    public static long getSunlight(double latitude, double longitude, Date date, double zenith, TimeZone tz) {
     ...
     * @return
     */
    public static double getSunlightHours(double latitude, double longitude, Date date) {
        return getSunlightHours(latitude, longitude, date, SunriseSunset.CIVIL_ZENITH, TimeZone.getDefault());
    }
     ...
     */
    public static double getSunlightHours(double latitude, double longitude, Date date, double zenith, TimeZone tz) {
        long sunlight = getSunlight(latitude, longitude, date, tz);
        long minutes = Math.round(sunlight / (1000 * 60));
        return (minutes / 60.0);
    }
    
    private static double getSunlightHours(double latitude, double longitude, Date date, TimeZone tz) {
        return getSunlightHours(latitude, longitude, date, SunriseSunset.CIVIL_ZENITH, tz);
    }
    ...
    public static Date getSunset(double latitude, double longitude) {
        return getSunset(latitude, longitude, new Date(), SunriseSunset.CIVIL_ZENITH, TimeZone.getDefault());
    }
    ...
    public static Date getSunset(double latitude, double longitude, Date date) {
        return getSunset(latitude, longitude, date, SunriseSunset.CIVIL_ZENITH, TimeZone.getDefault());
    }
     ...
     * @return GMT date of the rise.  If the sun does not rise, returns null
     */
    public static Date getSunset(double latitude, double longitude, Date date, TimeZone tz) {
        return getSunset(latitude, longitude, date, SunriseSunset.CIVIL_ZENITH, tz);
    }
     ...
     */
    public static Date getSunset(double latitude, double longitude, Date date, double zenith, TimeZone tz) {
        ...
        //consider DaylightTime difference
        int saving=tz.getDSTSavings();
        calendar.add(Calendar.MILLISECOND, saving);
    ...
    public static Date getSunrise(double latitude, double longitude) {
        return getSunrise(latitude, longitude, new Date(), SunriseSunset.CIVIL_ZENITH, TimeZone.getDefault());
    }
    ...
    public static Date getSunrise(double latitude, double longitude, Date date) {
        return getSunrise(latitude, longitude, date, SunriseSunset.CIVIL_ZENITH, TimeZone.getDefault());
    }
    
    
    public static Date getSunrise(double latitude, double longitude, Date date, TimeZone tz) {
        Date gmtDate =  getSunrise(latitude, longitude, date, SunriseSunset.CIVIL_ZENITH, tz);
     ...
     * @return GMT date of the rise.  If the sun does not rise, returns null
     */
    public static Date getSunrise(double latitude, double longitude, Date date, double zenith, TimeZone tz) {
    ...
    public static boolean isWholeDayNight(double latitude, double longitude, Date currDate)
	{
    	for(int i = 1; i<=365; i++)
		{
    		long diffDay = (long)i*24*60*60*1000;
    		Date calcDate = new Date(currDate.getTime() - diffDay);
    		Date sunriseTime = getSunrise(latitude, longitude, calcDate);
			Date sunsetTime = getSunset(latitude, longitude, calcDate);
