...
public class DataConnTEST18to23 extends DataConnBase
{
    private boolean blockingError = false;
    private boolean deviceOnLine = true;
    File fileOutput = new File(
            "C:\\swdept_prj\\plantvisorpro\\developments\\applications\\Director\\test data file\\WriteDataTest18to23.txt");
