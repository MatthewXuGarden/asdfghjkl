...
public class ReadDataTest12
{
    ...
    static File fileOutput = new File(
            "C:\\swdept_prj\\plantvisorpro\\developments\\applications\\Director\\test data file\\ReadDataTest12.txt");
    ...
    public static void main(String[] args) throws Throwable
    {
        ...
        while (resultSet.next())
        {
            ...
            for (int i = 1; i < 64; i++)
            {
                values[i - 1] = new Float(resultSet.getFloat(VALUE + i));
