package com.carel.supervisor.director.test.operativitanormaleb;
...
public class WriteDataTest extends Poller
{
    ...
    private static void request() throws Exception
    {
        ...
        try
        {
            ...
            System.out.print("Settare numero di valori ");
            str = myInput.readLine();
            ...
            {
                System.out.println("Kmax troppo grande per poter girare");
                System.exit(1);
            }
        } //try 
        catch (IOException e)
