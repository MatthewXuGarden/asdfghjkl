...
RemoteListBox.setScreenH(sessionUser.getScreenHeight());
RemoteListBox.setScreenW(sessionUser.getScreenWidth());
String remotelistbox = new RemoteListBox().getRemoteListBox(idsite,actioncode, language);
