...
String remote = lan.getString("action","remote");
...
//REMOTE
RemoteListBox remotelistboxobj = new RemoteListBox();
remotelistboxobj.setScreenH(sessionUser.getScreenHeight());
remotelistboxobj.setScreenW(sessionUser.getScreenWidth());
String remotelistbox = remotelistboxobj.getRemoteListBox(idsite,actioncode, language);

String modemAvailable = RemoteListBox.isDeviceConf(language);
String modemAvailableString = RemoteListBox.GetDeviceConf(idsite,language);
%>
...
<FORM id="frm_set_remote" name="frm_set_remote" action="servlet/master;jsessionid=<%=jsession%>" method="post">
