...
var jt_Veil = { /***** cooperates w/ 'jt_BodyZ', required by 'jt_DialogBox' */
	...
	css: {position:"absolute", display:"none", top:0, left:0, backgroundColor:"#000000", filter:"alpha(opacity=20)", opacity:0.2}
};
...
/**
 * generate a select's option , which will be used in Firefox and IE .and so on..
 * simon add in 2010-04-28
 * */
function newOption(val,key,selected){
