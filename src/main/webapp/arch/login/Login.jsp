...
<%
	...
	String site_name = site!=null?site.getName():"";
	...
	//  manage guardian in login page.
	String snooze = lan.getString("gd_login","snooze");
...
<input type="hidden" name="pagetype" id="pagetype" value="standard"/>
...
<input type='hidden' id='snooze' value='<%=snooze%>'/>
...
<div id="winclose" title="<%=lan.getString("top","exit")%>" style="position:absolute;top:1px;cursor:pointer" onclick="WinCloseBrowser();">
	<img src="images/top/exit.png" border="0" />
</div>

<% if( bLicense ) { %>

<table border="0" width="100%" height="97%">
	<tr>
		<td height="*" align="center" style='background-image: url("images/<%=path_image%>"); background-position: center center; background-repeat:no-repeat;' cellspacing="0" cellpadding="0">
			<div style="width:569;height:381;">
							...
							<table border="0" cellpadding="1" cellspacing="1" width="100%">
								<tr>
									...
									<td width="20%" align="left">
										<div id="guardivlogin" style="cursor: pointer;visibility:hidden;" class="snoozeGp_tooltip" onclick="snoozeGp();"  >
											<img title="<%=snooze %>" id="imgguardivlogin" src="images/gpro/guardian.gif" border="0"/ >
<!-- 											<span ></span> -->
										</div>
									</td>
								</tr>
					...
					<tr>
						...
						<td height="45%" align="left" valign="middle">
							<table border="0" cellspacing="<%=b_cellspacing %>" cellpadding="<%=b_cellspacing %>" width="100%">
								<tr>
									<td align="left" style="font-family:Tahoma;font-size:10pt;">Site</td>
									<td align="left" colspan="2"  style="font-family:Tahoma;font-size:10pt;">
										<%= site_name %>
									</td>
								</tr>
								<tr>
									...
									<td align="left" >
										<%if("true".equalsIgnoreCase(usercomboboxFlag) && !disabletxtUser.equals("disabled")){%>
											<%=usercombobox %>
										<%}else {%>
										<input <%=(OnScreenKey?"class='keyboardInput'":"")%> type="text" name="txtUser" <%=disabletxtUser%> id="txtUser" value="<%=userName %>" style="font-family:Tahoma;font-size:10pt;width:160;"  tabIndex="1" />
										<%} %>
									</td>
									<td align="center" style="background-image:url('images/login_bt.png');background-repeat:no-repeat;background-position:center;">
									  <a id="help" title="help" href="LOC_<%=usManLang%>/Content/Topic/Avvio-utente-locale__logon.htm" target="_blank" style="text-decoration:none;color:white"  tabIndex="50" onfocus="helponfocus();">&nbsp;&nbsp;&nbsp;&nbsp;?&nbsp;&nbsp;&nbsp;&nbsp;</a>
									</td>
								</tr>
								<tr style="<%=pwddisplay %>" id="pwdisplayMark">
									<td align="left" style="font-family:Tahoma;font-size:10pt;"><%=password %></td>
									<td align="left">
										<input <%=(OnScreenKey?"class='keyboardInput'":"")%> type="password" name=txtPassword id="txtPassword" value="" style="font-family:Tahoma;font-size:10pt;width:160;" tabIndex="2" />
									</td>
									<td align='center' style="<%=showsubmit1 %>">
										<div id="lgnbttprg">
											<input type="submit"  id="loginArea" name="btnLogin"  style="border:0px;cursor:hand;width:57px;height:20px;background-image:url('images/login_bt.png');background-color: transparent;color:white;" value="<%=login %>" onclick="<%=onclick %>" tabIndex="10" />
										</div>
									</td>
								</tr>
								<tr style="<%=newdisplay %>">
									...
									<td align="left">
										<input <%=(OnScreenKey?"class='keyboardInput'":"")%> type="password" name=npassword id="npassword" value="" style="font-family:Tahoma;font-size:10pt;width:160;" onblur='noBadCharOnBlur(this,event);' onkeydown="checkBadChar(this,event);" tabIndex="3" />
									</td>
								</tr>
								<tr style="<%=newdisplay %>" >
									<td align="left" style="font-family:Tahoma;font-size:10pt;"><%=confPassword %></td>
									<td align="left">
										<input <%=(OnScreenKey?"class='keyboardInput'":"")%> type="password" name=cpassword id="cpassword" value="" style="font-family:Tahoma;font-size:10pt;width:160;" onblur='noBadCharOnBlur(this,event);' onkeydown="checkBadChar(this,event);" tabIndex="4" />
									</td>
									<td align='center'>
										<div id="lgnbttprg">
											<input type="submit" id="loginArea2" name="btnLogin" style="border:0px;cursor:hand;width:57px;height:20px;background-image:url('images/login_bt.png');background-color: transparent;color:white;" value="<%=login %>" onclick="<%=onclick %>" tabIndex="10" />
										</div>
									</td>
								</tr>
								<tr>
									...
									<td align="center" style="<%=back%>">
										<div>
											<input type="button" value="<%=cancel %>" id="cancel" style="border:0px;cursor:hand;width:57px;height:20px;background-image:url('images/login_bt.png');background-color: transparent;color:white;" onclick="cancelChangepwd();" onfocus="helponfocus();" tabIndex="30" />
										</div>
									</td>
								</tr>
								<tr>
					...
					<tr>
						...
						<td height="20%" align="right" valign="bottom" style="padding-right:5px">&nbsp;</td>
					</tr>
				</table>
			</div>
		</td>
